    ...
    public class SubscriptionStorage : IDisposable, ILowMemoryHandler
    {
        ...
        public async Task<SubscriptionState> AssertSubscriptionConnectionDetails(long id, string name)
        {
            ...
            using (serverStoreContext.OpenReadTransaction())
            {
                ...
                // todo: in whos task is it, also return why we came to this decision
                ...
                if (whoseTaskIsIt != _serverStore.NodeTag)
                {
                    ...
                    foreach (var member in topology.Members)
                    {
                        if (whoseTaskIsIt != null)
                        {
                            ...
                            {
                                databaseTopologyAvailabilityExplanation[member] = "Is the mentor node and a valid member of the topology, it should be running the subscription";
                            }
